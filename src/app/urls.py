...
urlpatterns = [
    ...
    url(r'^edit/(?P<page_id>[0-9a-z]+)/$', views.license_xml_edit, name='editor'),
    ...
    url(r'^make_issue/$', views.issue, name='issue'),
    url(r'^make_pr/$', views.pull_request, name='pull-request'),
    url(r'^beautify/$', views.beautify, name='beautify'),
    ...
    url(r'^license_namespace_requests/$', views.licenseNamespaceRequests, name='license-namespace-requests'),
    url(r'^license_namespace_requests/(?P<licenseId>\d+)/$', views.licenseNamespaceInformation, name='license-namespace-information'),
    ...
    url(r'^edit_license_namespace_xml/(?P<license_id>[0-9]+)/$', views.edit_license_namespace_xml, name='license_namespace_xml_editor'),
    url(r'^edit_license_namespace_xml/$', views.edit_license_namespace_xml, name='license_namespace_xml_editor_none'),
